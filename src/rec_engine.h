...
struct rec_engine_funcs
{
    ...
    float (*recognize_stroke)(struct rec_engine *engine, stroke_t *stroke,
			       void *feature_data);
    int    (*set_option)(struct rec_engine *engine, const char *option, const char *value);
};
...
int rec_engine_init(rec_engine_t *engine, struct rec *rec, const char *engine_name);
void rec_engine_deinit(rec_engine_t *engine);

void *rec_engine_feature_data_alloc(rec_engine_t *engine, const char *feature_data_str);
...
int rec_engine_set_option(rec_engine_t *engine, const char *name, const char *value);
