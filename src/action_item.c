...
int action_item_key_init(action_item_t *item, const char *key, int press)
{
...
int action_item_exec_init(action_item_t *item, const char *exec)
{
...
action_key_data_t *action_key_data_alloc(const char *key, int press)
{
...
int action_key_data_init(action_key_data_t *key_data, const char *key, int press)
{
...
action_exec_data_t *action_exec_data_alloc(const char *exec)
{
...
int action_exec_data_init(action_exec_data_t *exec_data, const char *exec)
{
