...
struct rec_engine *rec_get_engine(rec_t *rec, const char *engine_name);
struct rec_mode *rec_get_mode(rec_t *rec, const char *mode_name);
...
int rec_verify(rec_t *rec, const char *file_name);
